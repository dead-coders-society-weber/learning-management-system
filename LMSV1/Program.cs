...
options.UseSqlServer(builder.Configuration.GetConnectionString("deadcoders") ?? throw new InvalidOperationException("Connection string 'LocalConnection' not found.")));
